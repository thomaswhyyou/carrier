defmodule Carrier.SSH.Fmt do
  @moduledoc """
  Pretty much copied over from Bootleg.UI: https://github.com/labzero/bootleg
  """
  ...
  def verbosity(setting \\ nil) do
    validate_verbosity(setting || Application.get_env(:carrier, :verbosity, :info))
  end
  ...
  def output_coloring do
    Application.get_env(:carrier, :output_coloring, true)
  end
end
